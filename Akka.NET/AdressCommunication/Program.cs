...
namespace AdressCommunication
{
    class Program
    {
        /*
        * Работа с акторами через адресную строку, ActorSelection
        * ActorSelection - использует ActorPath для управления акторами,
        * без использования IActorRef
        * 
        * Пример: 
